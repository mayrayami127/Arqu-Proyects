...
// Consultar líderes junto con sus proyectos asociados para contar la carga laboral
$endpoint = "lider?select=*,proyecto(*)";
$lideres  = supabase_get($endpoint, $baseUrl, $apiKey);

// Contar el total de líderes registrados
$totalLideres = is_array($lideres) ? count($lideres) : 0;
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Arqué Proyects — Líderes Técnicos</title>
    ...
    <div class="app-shell">
        <aside class="sidebar">
            ...
            <nav class="main-nav" aria-label="Navegación principal">
                ...
                <a class="nav-item active" href="lideres.php"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="8" r="3"/><path d="M5 19c.8-3.1 3.1-5 7-5s6.2 1.9 7 5M18 5.5a2.4 2.4 0 0 1 0 4.8M20 14c1.2.5 1.9 1.4 2.2 2.6"/></svg><span>Líderes Técnicos</span></a>
        ...
        <main class="main-content">
            ...
            <div class="page-content">
                <div class="page-toolbar">
                    ...
                    <a href="formLideres.php" class="btn-primary">+ Nuevo Líder</a>
                </div>
                    ...
                    <div class="table-wrap">
                        <table>
                            ...
                            <tbody>
                                <?php if (is_array($lideres) && count($lideres) > 0): ?>
                                    <?php foreach ($lideres as $lider): ?>
                                        <?php 
                                            ...
                                            // Contar cuántos proyectos lidera actualmente
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="4" style="text-align: center; padding: 20px;">No se encontraron líderes registrados.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
